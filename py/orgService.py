...
class IAMClient(object):
   ...
   <soapenv:Header>
         ...
         <wsse:UsernameToken wsu:Id="UsernameToken-1" xmlns:wsu="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-utility-1.0.xsd">
            ...
            <wsse:Nonce EncodingType="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-soap-message-security-1.0#Base64Binary">+gyCOJlGPRu8sYOwP+D+Qw==</wsse:Nonce>
            <wsu:Created>2014-12-06T01:49:02.953Z</wsu:Created>
         </wsse:UsernameToken>
      </wsse:Security>
       </soapenv:Header>
   <soapenv:Body>
      <ser:searchOrgByParentOrgid>
         <l>1262678244351298191</l>
      </ser:searchOrgByParentOrgid>
   </soapenv:Body>
</soapenv:Envelope>
"""
